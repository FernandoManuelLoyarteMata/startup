...
const testimonials = [
  {
    ...
    company: "Mayo Clinic",
    content:
      "As a pathologist, I was always searching for tools that could enhance the accuracy and efficiency of our diagnostic processes.  It detects cancerous cells with remarkable precision, significantly improving our ability to diagnose breast and pancreatic cancer.",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "As a radiologist, integrating DigPatho's AI tools into our workflow has significantly improved our diagnostic accuracy. The precision in detecting cancerous cells is unparalleled, making our job much easier.",
    categories: [1, 2, 4],
  },
  {
    ...
    content:
      "Using DigPatho's AI-driven analysis has revolutionized our approach to histological examinations. The speed and accuracy of their tools have greatly enhanced our diagnostic capabilities.",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "DigPatho's AI technology has been a vital addition to our pathology department. The ability to quickly and accurately analyze microscopic images has improved our efficiency and patient outcomes.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Incorporating DigPatho's AI solutions into our practice has been a game-changer. The enhanced accuracy and efficiency in detecting cancerous cells have made a significant impact on our diagnostic procedures.",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "Integrating DigPatho's AI tools into our pathology lab has significantly enhanced our diagnostic accuracy. The precision and speed of their analysis are truly impressive.",
    categories: [1, 3],
  },
  {
    ...
    content:
      "DigPatho's AI-driven histological analysis has been a breakthrough for our research. The detailed insights and rapid results have greatly benefited our studies.",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "The AI tools from DigPatho have revolutionized our diagnostic processes. The ability to quickly and accurately analyze histological images has improved our workflow and patient outcomes.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Using DigPatho's AI technology has been a game-changer for our oncology department. The precision in detecting cancerous cells has significantly improved our diagnostic capabilities.",
    categories: [1, 2],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          Discover How DigPatho's AI Technology is Transforming Diagnostics Hear from Our Clients About the Impact on Their Practices.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              {/* Button #1 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring focus-visible:ring-sky-200 ${
                  category === 1
                    ? "relative bg-gradient-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,theme(colors.sky.500/0),theme(colors.sky.500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]"
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 1 ? "text-sky-500" : "text-gray-600"
                  }`}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 2 ? "text-sky-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 3 ? "text-sky-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 4 ? "text-sky-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 5 ? "text-sky-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sky-200/65 before:content-['“'] after:content-['”']">
          {children}
        </p>
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-medium text-gray-200">
            ...
            <a
              className="text-sky-200/65 transition-colors hover:text-sky-500"
              href="#0"
            >
              {testimonial.company}
            </a>
