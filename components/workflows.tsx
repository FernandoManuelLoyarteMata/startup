      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            At Digpatho, our advanced AI algorithms analyze histological images to identify cells with specific characteristics and structures, tailored to the pathology being studied. We offer a range of diagnostic services, including HER2, Ki67, estrogen, and progesterone receptor analysis, as well as pancreatic and breast cancer detection. Our tools enable professionals to perform faster and more accurate analyses, saving time and effort while enhancing diagnostic precision.
            </p>
          </div>
          {/* Spotlight items */}
